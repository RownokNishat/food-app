export const Datas = [
  {
    ...
    service_id: "04",
    title: "Pizza",
    img: "https://p4.wallpaperbetter.com/wallpaper/161/113/135/pizza-fast-food-vegetables-food-wallpaper-preview.jpg",
    price: "1200",
    description:
    ...
    facility: [
      {
        name: "Italian pizza",
        details:
          "dish of Italian origin consisting of a flattened disk of bread dough topped with some combination of olive oil, oregano, tomato, olives, mozzarella.",
      },
      {
        name: "BBQ Pizza",
        details:
      ...
      {
        name: "Chicken meat ball pizza",
        details:
          "dish of Italian origin consisting of a flattened disk of bread dough topped with some combination of olive oil, oregano, tomato, olives, mozzarella.",
      },
      {
        name: "Pizza with peparony chilli",
        details:
          "dish of Italian origin consisting of a flattened disk of bread dough topped with some combination of olive oil, oregano, tomato, olives, mozzarella.",
      },
    ],
  },
  {
    ...
    service_id: "05",
    title: "Cake",
    img: "https://img4.goodfon.com/wallpaper/nbig/d/f2/desert-vypechka-pirozhnoe-krem-shokolad-klubnika.jpg",
    price: "20.00",
    description:
  ...
  },
  {
    ...
    service_id: "01",
    title: "Drinks",
    img: "https://wallpapercave.com/wp/wp11669203.jpg",
    price: "200.00",
    description:
      "Cost effective vanilla, chocolate, strawberry flavors for beverage companies.Ask us today! We make good nutrition taste even better. Perfect flavors for beverage products. Sustainable Flavors. Get a Free Quote. Clean label. Cost Effective Flavors. Quality Flavors.",
    facility: [
      {
  ...
  },
  {
    ...
    service_id: "02",
    title: "Tacos",
    img: "https://www.godairyfree.org/wp-content/uploads/2020/04/pics-Mexican-Mushroom-Beef-Tacos-feature.jpg",
    price: "150.00",
    description:
  ...
  },
  {
    ...
    service_id: "03",
    title: "Japaness Food",
    img: "https://www.elitehavens.com/magazine/wp-content/uploads/2019/10/Villa-Waimarie-Superb-food-scaled-e1591087245519.jpg",
    price: "30.00",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius veniam nostrum dolores nemo quas. Minima ullam, veniam, nesciunt quae dolore animi blanditiis deserunt, ea esse dolorum ipsum quibusdam ipsa! Corrupti at, excepturi, fugiat aut nihil neque aliquid sapiente dignissimos provident, animi molestiae ipsum. Repudiandae ipsa id nihil reiciendis ",
    facility: [
      ...
      {
        name: "chicken fry in deep chili oil",
        details:
          "Fuga numquam nulla nam, facere neque dignissimos ab esse magni accusamus eveniet ad corrupti, architecto nostrum.",
      },
    ],
  },
  {
    ...
    service_id: "06",
    title: "Ice cream",
    img: "https://thumbs.dreamstime.com/b/various-varieties-ice-cream-cones-various-varieties-ice-cream-cones-mint-blueberry-strawberry-pistachio-cherry-158155767.jpg",
    price: "20.00",
    description:
      "fugiat aut nihil neque aliquid sapiente dignissimos provident, animi molestiae ipsum. Repudiandae ipsa id nihil reiciendis soluta eos ducimus pariatur, nam architecto tenetur quo quos commodi est libero repellendus vitae. Fuga numquam nulla nam, facere neque expedita voluptatibus pariatur necessitatibus vel, dignissimos ab esse magni accusamus eveniet ad corrupti, architecto nostrum. Aspernatur ex quibusdam at cum nulla!",
    facility: [
